...
def cv_check(data,target,features,params,cv=5):
    ...
    return {'mean_rmse':rmse.mean(),'mean_mae':mae.mean(),'rmse':rmse,'mae':mae}
...
# submit = multi_model(
#     df,test_data,submit_csv,simple_features,features,
#     x_params=x_params,y_params=y_params,m_params=m_params,v_params=v_params
#     )
# submit
# # %%
# submit.to_csv('D:/Data/KAERI_dataset/submission_lgbm_separable.csv', index = False)
# print("Done!")
